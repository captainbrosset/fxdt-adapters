...
const {ChromiumTimelineActor} = require("./timeline")
...
var ChromiumTabActor = ActorClass({
  ...
  initialize: function(root, json) {
    ...
    this.timelineActorID = conn.manageLazy(this, conn.allocID(), () => {
      return ChromiumTimelineActor(this);
    });
  },
  ...
  form: function(detail) {
    return {
      ...
      timelineActor: this.timelineActorID
    }
  },
